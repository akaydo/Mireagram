        ...
        () => {
          ...
          getDownloadURL(uploadTask.snapshot.ref).then((downloadURL) => {
            fetch(`https://mireagram-api.vercel.app/api/post/user/post`, {
              ...
              alert("Ваша запись успешно опубликована!");
      ...
      <div className="content-upload-container">
        ...
        <div style={{ marginLeft: "10px" }}>
          {imagePre !== null ? (
            ...
            <video className="post-images" width="500" height="500" controls>
          ...
          <div style={{ display: "flex", justifyContent: "space-between" }}>
            <div>
              ...
              <img src={`${emojiIcon}`} className="icons-for-content" alt="" />
              <label htmlFor="file2">
                <img
                  src={`${VideoIcon}`}
                  className="icons-for-content"
